			...
			foreach ($category as $key => $value) {
				...
				<tr class="<?php if($key%2 == 0){echo 'even';}else{echo 'odd';} ?> pointer">
			        ...
			        <td class=" last">
			        	...
			        	<a class="btn btn-xs btn-info" href="{{ route('category.edit',$value->id) }}" title="Edit"><i class='fa fa-pencil'></i></a>
			        	<a class="deletebutton btn btn-xs btn-danger" onclick="return false;" href="{{ route('category.delete',$value->id) }}" title="Hapus"><i class='fa fa-trash'></i></a>
			        </td>
		        </tr>
				<?php
			}
