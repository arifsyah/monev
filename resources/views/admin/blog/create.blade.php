...
<div class="x_panel">
    ...
    <div class="x_content">
    	<br />
        <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="{{ route('blog.store') }}">
        	{{ csrf_field() }}
            ...
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <textarea name="summary" class="form-control col-md-7 col-xs-12"></textarea>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-9 col-sm-9 col-xs-12">
                    <textarea id="body" name="body" class="form-control col-xs-12"></textarea>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-9 col-sm-9 col-xs-12">
                    <div class="radio">
                        <label>
                            <input type="radio" value="0" name="status" <?php if(!isset($status)){echo "checked='checked'";} ?> > Nonaktif &nbsp;
                        </label>    
                        <label>
            ...
            <div class="form-group">
                ...
                <div class="col-md-9 col-sm-9 col-xs-12">
                    ...
                    <br/>
                    <div id="list-gambar" class="row"></div>
                </div>
            </div>
