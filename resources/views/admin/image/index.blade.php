    ...
    <div class="x_title">
        <form method="get">
        	<div class="col-xs-2" style="padding-left:0px;">
        		<input type="text" name="nama" class="form-control" placeholder="Title" value="{{ Request::input('nama') }}">
        	</div>
		        	...
		        	foreach ($image as $key => $value) {
		        		...
		        		<tr class="<?php if($key%2 == 0){echo 'even';}else{echo 'odd';} ?> pointer">
					        ...
					        <td class=" last">
					        	...
					        	<a class="btn btn-xs btn-info" href="{{ route('image.edit',$value->id) }}">Edit</a>
					        	<a class="deletebutton btn btn-xs btn-danger" onclick="return false;" href="{{ url('image/delete').'/'.$value->id }}">Delete</a>
					        </td>
		                </tr>
		        		<?php
		        	}
