...
<div class="x_panel">
    ...
    <div class="x_content">
    	<br />
        <form id="form2" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data" method="post" action="{{ route('file.store') }}">
        	{{ csrf_field() }}
            ...
            <div class="form-group{{ $errors->has('title') ? ' has-error' : '' }}">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="text" id="title" name="title" required="required" class="form-control col-md-7 col-xs-12" value="{{$old['title'] ?? ''}}">
            ...
            <div class="form-group{{ $errors->has('tag') ? ' has-error' : '' }}">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <select class="itemTag form-control" style="height:34px;" name="itemTag[]" multiple="multiple"></select>
                    <input type="hidden" id="id_tags" name="id_tags[]" value="">
            ...
            <div class="form-group{{ $errors->has('bidang') ? ' has-error' : '' }}">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <select class="itemNameBidang form-control" style="height:34px;" name="itemNameBidang"></select>
