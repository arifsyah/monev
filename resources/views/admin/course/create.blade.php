...
<div class="x_panel">
    ...
    <div class="x_content">
    	<br />
        <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="{{ route('course.store') }}">
        	{{ csrf_field() }}
            ...
            <div class="form-group {{ $errors->has('date_open') ? ' has-error' : '' }}">
                ...
                <div class="col-md-3 col-sm-3 col-xs-6">
                    <input type="text" id="date_open" name="date_open" class="form-control col-md-7 col-xs-12">
            ...
            <div class="form-group {{ $errors->has('date_closed') ? ' has-error' : '' }}">
                ...
                <div class="col-md-3 col-sm-3 col-xs-6">
                    <input type="text" id="date_closed" name="date_closed" class="form-control col-md-7 col-xs-12">
