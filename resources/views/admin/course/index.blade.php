        ...
        <form method="get">
        	...
        	<div class="col-xs-2 pull-right">
        		<ul class="nav navbar-right panel_toolbox">
		            <li>
		                <a href="{{ route('course.create') }}" >Add Kelas</a>
		            </li>
		        </ul>
        	</div>
		        	...
		        	foreach ($course as $key => $value) {
		        		...
		        		<tr class="<?php if($key%2 == 0){echo 'even';}else{echo 'odd';} ?> pointer">
					        ...
					        <td class=" last">
					        	...
					        	<a class="btn btn-xs btn-info" href="{{ route('course.edit',$value->id) }}">Edit</a>
					        	<a class="deletebutton btn btn-xs btn-danger" onclick="return false;" href="{{ url('admin/course/delete').'/'.$value->id }}">Delete</a>
					        </td>
		                </tr>
		        		<?php
		        	}
